      ...
      <div className="flex justify-between bg-slate-300 ">
        <div className="w-4/12 h-screen bg-white mt-5 ml-6 rounded-md flex flex-col ">
          <div className="ml-10">
            ...
            <button className="mt-5 w-8/12 bg-blue-600 mx-auto py-3 text-md text-white rounded-lg">
              + New spot
            </button>
          </div>
          <div className="ml-10 mt-6">
            <h2 className="mt-5 text-lg ">Create new Community</h2>
            <button className="mt-5 w-8/12 bg-purple-600 mx-auto py-3 text-md text-white rounded-lg">
              + New Community
            </button>
          </div>
